...
ADD `payway_state` VARCHAR(80) NULL;";

// Create table banks
$sql[] = "
CREATE TABLE `{$dbx}payway_banks` (
...
$sql[] = "
CREATE TABLE `{$dbx}payway_promotions` (
...
$sql[] = "
CREATE TABLE `{$dbx}payway_installments` (
