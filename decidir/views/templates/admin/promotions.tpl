...
<form action="" method="post" class="form-horizontal">
    <div class="panel col-lg-12">
        <div class="panel-heading">
            <span>{l s='Promotions' mod='decidir'}</span>
            ...
            <table class="table table-striped">
                <thead>
                    <tr class="nodrag nodrop">
                        ...
                        <th>{l s='Shops' mod='decidir'}</th>
                        <th class="center">{l s='Active' mod='decidir'}</th>
                        <th class="center fixed-width-xs">{l s='Position' mod='decidir'}</th>
        ...
        <div class="modal-dialog decidir-modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{l s='New promotion' mod='decidir'}</h4>
                </div>
                <div class="modal-body form-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <!-- Merchant ID -->
                            <div class="form-group decidir-col-form-group">
                                <label>{l s='Merchant ID' mod='decidir'}</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Cards -->
                            <div class="form-group decidir-col-form-group">
                                <label>{l s='Cards' mod='decidir'}</label>
                        ...
                        <div class="col-lg-6">
                            <!-- Banks -->
                            <div class="form-group decidir-col-form-group">
                                <label>{l s='Banks' mod='decidir'}</label>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Applicable days -->
                            <div class="form-group decidir-col-form-group">
                                <label>{l s='Applicable days' mod='decidir'}</label>
                                <select name="decidir-new-promotion-applicable-days[]" multiple autocomplete="off">
                                    <option value="1" selected>{l s='Monday' mod='decidir'}</option>
                                    <option value="2" selected>{l s='Tuesday' mod='decidir'}</option>
                                    <option value="3" selected>{l s='Wednesday' mod='decidir'}</option>
                                    <option value="4" selected>{l s='Thursday' mod='decidir'}</option>
                                    <option value="5" selected>{l s='Friday' mod='decidir'}</option>
                                    <option value="6" selected>{l s='Saturday' mod='decidir'}</option>
                                    <option value="7" selected>{l s='Sunday' mod='decidir'}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            ...
                            <div class="form-group decidir-col-form-group decidir-input-icon">
                                <label>{l s='From date' mod='decidir'}</label>
                            ...
                            <!-- Date to -->
                            <div class="form-group decidir-col-form-group decidir-input-icon">
                                <label>{l s='To date' mod='decidir'}</label>
                                <input type="text" class="decidir-datepicker"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <!-- Shops -->
                            <div class="form-group decidir-col-form-group">
                                <label>{l s='Shops' mod='decidir'}</label>
                        ...
                        <div class="col-lg-6">
                            <!-- Position -->
                            <div class="form-group decidir-col-form-group">
                                <label>{l s='Position' mod='decidir'}</label>
                            ...
                            <div class="form-group decidir-col-form-group">
                                ...
                                <span class="switch prestashop-switch fixed-width-lg">
                                    ...
                                    <label for="decidir-new-promotion-active-on">{l s='Yes' mod='decidir'}</label>
                                    <input id="decidir-new-promotion-active-off" type="radio" name="decidir-new-promotion-active" value="0">
                                    <label for="decidir-new-promotion-active-off">{l s='No' mod='decidir'}</label>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading decidir-nobg">
                            <span>{l s='Installments' mod='decidir'}</span>
                            <span class="panel-heading-action">
                        ...
                        <div class="table-responsive-row decidir-table-installments">
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>{l s='Installment' mod='decidir'}</th>
    ...
    <div id="decidir-modal-promotion-{$promotion->id_promotion}" class="modal fade" role="dialog">
        <div class="modal-dialog decidir-modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">{l s='Edit promotion' mod='decidir'}</h4>
                </div>
                <div class="modal-body form-wrapper">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group decidir-col-form-group">
                                ...
                                <select name="decidir-upd-promotion-applicable-days-{$promotion->id_promotion}[]" multiple autocomplete="off">
                                    <option value="1" {if in_array(1, $promotion->applicable_days)}selected{/if}>{l s='Monday' mod='decidir'}</option>
                                    <option value="2" {if in_array(2, $promotion->applicable_days)}selected{/if}>{l s='Tuesday' mod='decidir'}</option>
                                    <option value="3" {if in_array(3, $promotion->applicable_days)}selected{/if}>{l s='Wednesday' mod='decidir'}</option>
                                    <option value="4" {if in_array(4, $promotion->applicable_days)}selected{/if}>{l s='Thursday' mod='decidir'}</option>
                                    <option value="5" {if in_array(5, $promotion->applicable_days)}selected{/if}>{l s='Friday' mod='decidir'}</option>
                                    <option value="6" {if in_array(6, $promotion->applicable_days)}selected{/if}>{l s='Saturday' mod='decidir'}</option>
                                    <option value="7" {if in_array(7, $promotion->applicable_days)}selected{/if}>{l s='Sunday' mod='decidir'}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group decidir-col-form-group">
                                ...
                                <span class="switch prestashop-switch fixed-width-lg">
                                    ...
                                    <label for="decidir-upd-promotion-active-on-{$promotion->id_promotion}">{l s='Yes' mod='decidir'}</label>
                                    ...
                                    <label for="decidir-upd-promotion-active-off-{$promotion->id_promotion}">{l s='No' mod='decidir'}</label>
                                    <a class="slide-button btn"></a>
                                </span>
                            </div>
                        </div>
...
$('[name="decidir-del-promotion"]').on('click', function(e){
    if (!confirm("{l s='Delete promotion?' mod='decidir'}")) {
        return false;
    }
});
