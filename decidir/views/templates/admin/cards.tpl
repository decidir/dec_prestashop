...
<form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
    <div class="panel col-lg-12">
        <div class="panel-heading">
            <span>{l s='Cards' mod='decidir'}</span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{l s='New card' mod='decidir'}</h4>
                </div>
    ...
    <div id="decidir-modal-card-{$card->id_card}" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">{l s='Edit card' mod='decidir'}</h4>
                </div>
                <div class="modal-body form-wrapper">
...
$('[name="decidir-del-card"]').on('click', function(e){
    if (!confirm("{l s='Delete card?' mod='decidir'}")) {
        return false;
    }
});
