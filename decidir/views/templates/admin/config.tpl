...
<form action="" method="post">
    ...
    <ul class="decidir-tabs nav nav-tabs">
        <li {if ($tab == 'crds')}class="active"{/if} data-sel="spl">
            <a data-toggle="tab" href="#decidir-tab-crds">{l s='Credentials' mod='decidir'}</a>
        </li>
        <li {if ($tab == 'opts')}class="active"{/if} data-sel="grp">
            <a data-toggle="tab" href="#decidir-tab-opts">{l s='Options' mod='decidir'}</a>
        </li>
    </ul>
    ...
    <div class="decidir-tab-panel tab-content panel panel-default form-horizontal">
        ...
        {if ($tab == 'opts')}active{/if}">
            <div class="form-wrapper">
                ...
                <div class="form-wrapper">
                    <div class="form-group">
                        <label class="control-label col-lg-3">{l s='Payment option title' mod='decidir'}</label>
                        <div class="col-lg-8">
                            <input type="text" name="decidir-ttl" value="{$data->ttl}">
                            <div><small><i>*{l s='Text to display in the checkout process' mod='decidir'}.</i></small></div>
                        </div>
                    </div>
                </div>
